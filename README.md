...
built with [SimPy](https://simpy.readthedocs.io/). Originally prototyped
inside [planet_sim](https://github.com/MathewsGreg/planet_sim), spun out here
as its own project — same "build the thing, watch it in a browser" approach,
much smaller scope.
...
python build_port_page.py                  # inlines it into docs/index.html
```
...
| `build_port_page.py` | Inlines `port_data.json` into `port_template.html` → `docs/index.html` |
